...
#authorizer.add_user(username=config.USERNAME, password=config.PASSWORD, homedir=directory2, perm="elradfmwMT")

# create anonymous user
authorizer.add_anonymous(homedir=directory2, perm="elr")
